...
import { ServerStats, getServerStats } from "../actions/server-stats";
      ...
      <div className="p-4">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4 mb-8">
            ...
            <CardContent>
              <div className="flex items-center justify-between">
                <div className="text-3xl font-bold text-primary">
                  {serverStats.playerCount.online} /{" "}
                  {serverStats.playerCount.max}
                </div>
                <div
                  className={`${
                    serverStats.isOnline
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-3xl font-bold text-primary">
                {serverStats.memoryUsage.used} / {serverStats.memoryUsage.max}{" "}
                GB
              </div>
            </CardContent>
            <CardFooter className="pt-0">
